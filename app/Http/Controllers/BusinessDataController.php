...
class BusinessDataController extends Controller
{
    public function index()
    {
        ...
        $business_data = BusinessData::select('name', 'address', 'phone', 'email', 'updated_at')->first();

        return view('admin.catalogs.master-data.business-data.show', ['business_data' => $business_data]);
    }
