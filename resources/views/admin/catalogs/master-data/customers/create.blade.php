...
<head>
    ...
    <title>Registar Nuevo Cliente | Sistema Web DJ</title>
        ...
        <form action="{{ route('customer.store') }}" method="post" class="form w-adjustable">
            ...
            <div class="button--back">
                <a href="{{ route('register.create') }}">
                    ...
                    <button class="button text-grey" type="button">Volver al módulo de registrar nueva cuenta</button>
                </a>
            </div>
                ...
                <div class="form__item">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="customer_name" id="customer_name"
                            ...
                            aria-label="Nombre del cliente" autofocus value=" ">
                    </div>
                ...
                <div class="form__item">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="customer_lastname" id="customer_lastname"
                            ...
                            placeholder="Ej: Pérez" aria-label="Apellido del cliente" value=" "> {{-- Assuming
                ...
                <div class="form__item">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-select @error('identity_card_id') is-invalid @enderror"
                            ...
                            <option value="1">Venezolano cedulado</option>
                            <option value="2">Extranjero cedulado</option>
                            <option value="3">Ciudadano no cedulado</option>
                        </select>
                    </div>
                ...
                <div class="form__item">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="card" id="card"
                            ...
                            aria-label="Número de documento de identidad del cliente" value="">
                    </div>
